    ...
    <div class="page-wrapper">
      <a-row :gutter="24">
        ...
        <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
          <chart-card
            :loading="loading"
            title="逾期任务"
            :total="taskData.taskOverdueCount | NumberFormat"
          >
            <a-tooltip title="指标说明" slot="action">
              <a-icon type="info-circle-o" />
            </a-tooltip>
            ...
            <template slot="footer">
              逾期率
              <span>{{taskData.taskOverduePercent}}%</span>
            </template>
          </chart-card>
        </a-col>
        <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
          <chart-card :loading="loading" title="整体进度" :total="`${projectData.projectSchedule}%`">
            ...
            <div>
              <mini-progress
                color="#ffd401"
                :target="80"
                :percentage="projectData.projectSchedule"
                height="8px"
              />
            </div>
            <template slot="footer">
      ...
      <a-row :gutter="12">
          ...
          <a-card :loading="loading" :bordered="false" :body-style="{padding: '0'}">
            <div class="salesCard">
              <a-tabs
                ...
                size="large"
                :tab-bar-style="{marginTop: '3px',marginBottom: '24px', paddingLeft: '16px'}"
              >
        ...
        <a-col :xl="6" :lg="24" :md="24" :sm="24" :xs="24">
          <a-card :loading="loading" :bordered="false" title="我的项目">
            ...
            <p v-for="project in projectList" :key="project.id">
              <router-link
                target="_blank"
                :to="'/project/space/task/' + project.code"
