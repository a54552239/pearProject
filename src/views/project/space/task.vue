<template>
  <div class="project-space-task" ref="taskarea" :class="project.task_board_theme">
    <a-row class="project-navigation" align="middle" justify="center">
      ...
      <a-col class="nav-body" :span="8" :xs="24" :sm="24" :md="24" :lg="8">
        <ul class="nav-wrapper nav nav-underscore">
          <li class="actives" data-app="tasks" @click="init">任务</li>
      ...
      <a-col class="project-nav-footer" :span="8" :xs="24" :sm="24" :md="24" :lg="8">
    ...
    <wrapper-content :style="{height:'100%'}" :showHeader="false">
      <draggable
        v-model="taskStages"
                        ...
                        <div class="task-content-set open-detail">
                          ...
                          <div class="task-info-wrapper clearfix">
                            <div class="task-infos">
                              <span
                                class="icon-wrapper"
                                :style="{color: getStatusColor(task.status), fontSize: '12px'}"
                                v-if="task.status"
                        ...
                        <a-dropdown :trigger="['click']">
                          <a class="executor-handler">
                            <img
                              ...
                              class="avatar img-circle img-24 hinted"
                            />
                            <span class="creator-handler-text name">{{ defaultExecutor.name }}</span>
                          </a>
                          <a-menu
                          ...
                          <div class="task-info-wrapper clearfix">
                            <div class="task-infos">
                              <span
                                ...
                                v-for="(tag,tag_index) in task.task_tag_item_list"
                                :key="tag.code"
                              >{{ tag.name }}</span>
                            </div>
                          </div>
