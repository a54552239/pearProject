<template>
  <div class="project-space-overview" :class="project.task_board_theme">
    <a-row class="project-navigation" align="middle" justify="center">
      ...
      <a-col class="nav-body" :span="8" :xs="24" :sm="14" :md="8" :lg="8">
        <ul class="nav-wrapper nav nav-underscore">
          ...
          <li class="actives" data-app="build" @click="init">概览</li>
    ...
    <wrapper-content :showHeader="false">
      ...
      >
        <a-col :span="16" :xs="24" :sm="24" :md="16" :lg="16">
              ...
              <a-list>
                <a-list-item :key="index" v-for="(item, index) in projectInfoList">
                  <a-list-item-meta>
                    ...
                    <div slot="description">{{ item.value }}</div>
                  </a-list-item-meta>
                ...
                <a-list-item :key="index" v-for="(item, index) in activities">
                  <a-list-item-meta>
                    ...
                    <div slot="title">
                      ...
                      <span class="right-item muted">{{ formatTime(item.create_time) }}</span>
                    </div>
        ...
        <a-col :span="8" :xs="24" :sm="24" :md="8" :lg="8">
          <div class="content-item">
            <div class="list-content">
