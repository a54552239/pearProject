  ...
  <div class="main">
    ...
    >
        ...
        <a-tab-pane key="tab1" tab="账号密码登录">
          <a-form-item>
            <a-input
              ...
              v-decorator="[
                                'account',
                                {rules: [{ required: true, message: '请输入帐户名或邮箱地址' },{ validator: this.handleUsernameOrEmail }], validateTrigger: 'change'}
                            ]"
            >
        ...
        <a-tab-pane key="tab2" tab="手机号登录">
          <a-form-item>
            <a-input
              ...
              v-decorator="[
                                'mobile',
                                {rules: [{ required: true, pattern: /^1[3456789]\d{9}$/, message: '请输入正确的手机号' },{ validator: this.handleUsernameOrEmail }], validateTrigger: 'change'}
                            ]"
            >
      ...
      <div class="user-login-other">
        <span>其他登录方式</span>
        <a-tooltip :mouseEnterDelay="0.3" title="钉钉登录">
