        ...
        <span class="header-action text-right">
          <template v-if="!task.deleted">
            <a-tooltip :mouseEnterDelay="0.5">
              ...
              <a class="action-item muted" v-clipboard="taskLink" @success="copyLink"
                ><a-icon type="link"
              /></a>
            </a-tooltip>
            <a-tooltip :mouseEnterDelay="0.5">
              ...
              <a
                ...
                :class="{ active: task.liked }"
                @click="like(!task.liked)"
              >
                <a-icon type="like" />
        ...
        <div class="task-content">
                        ...
                        >
                          ...
                          <div slot="overlay">
                            <task-member-menu
                              ...
                              @close="init(false)"
                              @inviteProjectMember="
                                (showInviteMember = true), (visibleTaskMemberMenu = false)
                              "
                            ></task-member-menu>
                          </div>
                        </a-dropdown>
                    ...
                    <div class="field">
                      ...
                      <div class="field-right width-block">
                        ...
                        <div class="m-t-sm" v-if="hasMoreDesc">
                          <a v-show="!showMoreDesc" @click="checkShowMoreDesc(true)"
                            >显示更多</a
                          >
                          <a v-show="showMoreDesc" @click="checkShowMoreDesc(false)"
                            >收起备注</a
                          >
                        </div>
                        <div v-show="showTaskDescriptionEdit">
                          ...
                          <div class="action-btn pull-right">
                            <a
                              ...
                              @click="
                                (showTaskDescriptionEdit = false), initContent(false)
                              "
                            >
                              取消
                            </a>
                      ...
                      <div class="field-left">
                        ...
                        <span class="field-name"
                          ...
                          <span v-show="childTaskList.length">
                            · {{ childTaskDoneNum }}/{{ childTaskList.length }}</span
                          ></span
                        >
                      </div>
                          ...
                          <div class="task-list" v-show="childTaskList.length">
                            <div v-for="done in [0, 1]" :key="done">
                              <div
                                ...
                                :key="childTask.code"
                              >
                                <div class="list-item task" v-if="childTask.done == done">
                                  <a-tooltip placement="top">
                                    <template slot="title">
                                      <span
                              ...
                              <div class="list-item task m-l-xs">
                                <div class="task-item task-title hover-none">
                                  <div class="title-text">
                                    ...
                                    {{ workTime.member.name }}
                                    {{
                                      moment(workTime.begin_time).format(
                                        "MM月DD日 HH:mm"
                                      )
                                    }}开始 工时为 {{ workTime.num }} 小时
                                    <div
                                      class="muted"
          ...
          <div class="content-right">
              ...
              <div class="member-list">
                ...
                >
                  ...
                  <a-avatar
                    ...
                    @click="
                      routerLink(
                        '/members/profile/' + member.membar_account_code + '?key=3'
                      )
                    "
                  />
                </a-tooltip>
                ...
                >
                  ...
                  <div slot="overlay">
                    <project-member-menu
                      ...
                      @close="init(false)"
                      @inviteProjectMember="
                        (showInviteMember = true), (visibleProjectMemberMenu = false)
                      "
                    ></project-member-menu>
                  </div>
                </a-dropdown>
            ...
            <div class="footer" id="footer">
              ...
              <a-button class="middle-btn" type="primary" @click="createComment"
                >评论</a-button
              >
            </div>
          </div>
        ...
        <div class="work-time-stats">
          ...
          <div class="work-time-item">
            ...
            <span class="work-time-num">
              ...
              <template v-else>{{
                (task.work_time * 100 - workTimeTotal * 100) / 100
              }}</template>
            </span>
            <span>小时</span>
          </div>
  ...
  methods: {
    ...
    doBeginTime(setBeginTime = false, showBeginTime = false) {
      ...
      if (setBeginTime) {
        ...
        this.task.begin_time_format = moment(this.task.begin_time).format(
          "MM月DD日 HH:mm"
        );
      } else {
        beginTime = "";
    ...
    workTimePlainHandleSubmit() {
      let app = this;
      this.plainWorkTime.form.validateFields((err, values) => {
        if (!err) {
    ...
    workTimeHandleSubmit() {
      let app = this;
      this.workTimeDo.form.validateFields((err, values) => {
        if (!err) {
    ...
    departmentMemberDetail(code) {
      detail({
        code: code,
        organization: this.$store.state.currentOrganization.code,
      }).then((res) => {
