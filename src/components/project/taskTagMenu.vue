    ...
    <a-spin :spinning="listLoading">
      ...
      <div class="search-content">
        <a-input
          v-model="keyword"
          size="large"
          :placeholder="(creating || editing) ? '标签名称': '搜索标签'"
        >
            ...
            <div class="list-group">
              ...
              >
                ...
                >
                  ...
                  <a-list-item-meta>
                    <span class="tag-title" slot="title">
                      <a-badge status="success" :class="`badge-${item.color}`" />
                      {{item.name}}
                    </span>
                  </a-list-item-meta>
                </a-list-item>
      ...
      <div class="footer">
        ...
        <template v-else>
          <a-button
            ...
            size="large"
            block
            @click="creating = true,activeCreating = true"
          >新建标签</a-button>
        </template>
      </div>
    </a-spin>
  ...
  methods: {
    ...
    saveTag() {
      edit({
        ...
        this.currentTag.tag.name = this.listTemp[
          this.currentTag.index
        ].name = this.keyword;
        this.currentTag.tag.color = this.listTemp[
          this.currentTag.index
        ].color = this.currentBadge;
