                            ...
                            <div class="file-info">
                              <div class="file-content">
                                ...
                                <div class="file-extra">
                                  ...
                                  <span
                                    v-else
                                  >({{(Number(file.uploadedSize) / (1024 * 1000)).toFixed(2) }}MB/{{file.formatedSize }})</span>
                                </div>
                              </div>
                              <div class="uploader-progress" v-show="file.status != 'success'">
                                <a-progress
                                  :strokeWidth="2"
                                  :showInfo="false"
...
export default {
  ...
  data() {
    return {
      ...
      attrs: {
        accept:
          "image/*,video/*,audio/*,text/*,Model/*,drawing/*,application/*",
      },
      autoStart: true,
    };
  },
