...
const router = new Router({
  routes: [
    ...
    // },
    {
      ...
      path: "/member",
      component: (resolve) =>
        require(["@/components/layout/UserLayout"], resolve),
      meta: { model: "Login" },
      children: [
        {
          path: "login",
          name: "login",
          component: () =>
            import(/* webpackChunkName: "user" */ "@/views/member/login"),
          meta: { model: "Login" },
        },
        {
          path: "register",
          name: "register",
          component: () =>
            import(/* webpackChunkName: "user" */ "@/views/member/Register"),
          meta: { model: "Login" },
        },
        {
          path: "forgot",
          name: "forgot",
          component: () =>
            import(/* webpackChunkName: "user" */ "@/views/member/forgot"),
          meta: { model: "Login" },
        },
        // {
